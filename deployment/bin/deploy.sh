...
if [ ! -d $PROJECT_DIR"/.git" ]; then
  GIT_SSH_COMMAND='ssh -i /home/laercio/.ssh/id_rsa -o IdentitiesOnly=yes' git clone git@github.com:laerciokelson/devops.git .
else
  GIT_SSH_COMMAND='ssh -i /home/laercio/.ssh/id_rsa -o IdentitiesOnly=yes' git pull
fi
